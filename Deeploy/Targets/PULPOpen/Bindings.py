...
PULPMaxPool1DBindings = [
    NodeBinding(PULPMaxPoolChecker([PointerClass(type)], [PointerClass(type)]), FloatMaxPoolTemplate.reference1DTemplate,
...
PULPFloatConv1DBindings = [NodeBinding(ConvChecker(
