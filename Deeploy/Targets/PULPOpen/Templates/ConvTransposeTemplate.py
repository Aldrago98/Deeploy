...
// 2D Integer ConvTranspose CHW on PULPOpen/Siracusa (Name: ${nodeName}, Op: ${nodeOp})
${data_in_type.typeName} ref_${data_out}_${data_in} = ${data_in};
${data_out_type.typeName} ref_${data_out}_${data_out} = ${data_out};

for (uint32_t n=0; n<${batch}; ++n) {
    PULP_ConvTranspose2d_s${data_in_type.referencedType.typeWidth}_s${weight_type.referencedType.typeWidth}_s${data_out_type.referencedType.typeWidth}_CHW(
        ref_${data_out}_${data_in},
        ${ch_im_in}, ${dim_im_in_x}, ${dim_im_in_y},
        ${weight},
        ${ch_im_out}, ${group},
